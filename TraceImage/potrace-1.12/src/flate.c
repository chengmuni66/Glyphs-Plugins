...
int pdf_xship(FILE *f, int filter, char *s, int len) { return dummy_xship(f, filter, s, len); }

int flate_xship(FILE *f, int filter, char *s, int len) { return dummy_xship(f, filter, s, len); }
